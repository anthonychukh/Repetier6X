...
/* 
    Repeiter 6 axis is a WIP project to include 6-axis + E capability to Repetier.
    Repeiter 6 axis is base upon version 1.0.3
    Search for "6axis" comments for modified code.
 */
...
#define MOTHERBOARD 35 //33 = Ramp 1.4, 35 = azteeg pro
#define NUM_AXES 6 //v2. X,Y,Z for 3 primary axis. A,B,C would be 4,5,6
#include "pins.h"
...
#define DRIVE_SYSTEM 3  //1 = cartisan,  3 = delta
#define ROTATION_SYSTEM 1     // 6axis Define system of rotation WIP  1==SPM. Not implemented yet
#define XAXIS_STEPS_PER_MM 80   //orginally 80, 10 to test step debug
#define YAXIS_STEPS_PER_MM 80
#define ZAXIS_STEPS_PER_MM 80
#define AAXIS_STEPS_PER_MM 88   //6axis rotation step per degree
#define BAXIS_STEPS_PER_MM 88   //6axis
#define CAXIS_STEPS_PER_MM 88   //6axis
...
#define EXT0_A_OFFSET 0 //6axis
#define EXT0_B_OFFSET 0 //6axis
#define EXT0_C_OFFSET 0 //6axis
#define EXT0_STEPS_PER_MM 370
#define EXT0_TEMPSENSOR_TYPE 1
#define EXT0_TEMPSENSOR_PIN TEMP_0_PIN
#define EXT0_HEATER_PIN HEATER_0_PIN
#define EXT0_STEP_PIN -1 //ORIG_E0_STEP_PIN
#define EXT0_DIR_PIN -1 //ORIG_E0_DIR_PIN
#define EXT0_INVERSE 0
#define EXT0_ENABLE_PIN -1 //ORIG_E0_ENABLE_PIN
#define EXT0_ENABLE_ON 0
#define EXT0_MIRROR_STEPPER 0
#define EXT0_STEP2_PIN -1// ORIG_E0_STEP_PIN
#define EXT0_DIR2_PIN -1 //ORIG_E0_DIR_PIN
#define EXT0_INVERSE2 0
#define EXT0_ENABLE2_PIN -1// ORIG_E0_ENABLE_PIN
...
#define EXT1_TEMPSENSOR_TYPE 10
#define EXT1_TEMPSENSOR_PIN TEMP_1_PIN
#define EXT1_HEATER_PIN HEATER_2_PIN
#define EXT1_STEP_PIN 1-//ORIG_E1_STEP_PIN
#define EXT1_DIR_PIN -1//ORIG_E1_DIR_PIN
#define EXT1_INVERSE 0
#define EXT1_ENABLE_PIN -1 //ORIG_E1_ENABLE_PIN
#define EXT1_ENABLE_ON 0
#define EXT1_MIRROR_STEPPER 0
#define EXT1_STEP2_PIN -1 //ORIG_E1_STEP_PIN
#define EXT1_DIR2_PIN -1// ORIG_E1_DIR_PIN
#define EXT1_INVERSE2 0
#define EXT1_ENABLE2_PIN -1 //ORIG_E1_ENABLE_PIN
...
#define EXT2_TEMPSENSOR_TYPE 10
...
#define FILAMENTCHANGE_A_POS 0  //6axis
#define FILAMENTCHANGE_B_POS 0  //6axis
#define FILAMENTCHANGE_C_POS 0  //6axis
...
#define ENDSTOP_PULLUP_A_MIN true   //6axis
#define ENDSTOP_PULLUP_B_MIN true
#define ENDSTOP_PULLUP_C_MIN true
#define ENDSTOP_PULLUP_X_MAX true
#define ENDSTOP_PULLUP_Y_MAX true
#define ENDSTOP_PULLUP_Z_MAX true
#define ENDSTOP_PULLUP_A_MAX true   //6axis
#define ENDSTOP_PULLUP_B_MAX true
#define ENDSTOP_PULLUP_C_MAX true

#define ENDSTOP_X_MIN_INVERTING true
#define ENDSTOP_Y_MIN_INVERTING true
#define ENDSTOP_Z_MIN_INVERTING true
#define ENDSTOP_A_MIN_INVERTING true
#define ENDSTOP_B_MIN_INVERTING true
#define ENDSTOP_C_MIN_INVERTING true
#define ENDSTOP_X_MAX_INVERTING false
#define ENDSTOP_Y_MAX_INVERTING false
#define ENDSTOP_Z_MAX_INVERTING false
#define ENDSTOP_A_MAX_INVERTING false
#define ENDSTOP_B_MAX_INVERTING false
#define ENDSTOP_C_MAX_INVERTING false

#define MIN_HARDWARE_ENDSTOP_X false
#define MIN_HARDWARE_ENDSTOP_Y false
#define MIN_HARDWARE_ENDSTOP_Z false
#define MIN_HARDWARE_ENDSTOP_A true
#define MIN_HARDWARE_ENDSTOP_B true
#define MIN_HARDWARE_ENDSTOP_C true
#define MAX_HARDWARE_ENDSTOP_X true
#define MAX_HARDWARE_ENDSTOP_Y true
#define MAX_HARDWARE_ENDSTOP_Z true
#define MAX_HARDWARE_ENDSTOP_A false
#define MAX_HARDWARE_ENDSTOP_B false
#define MAX_HARDWARE_ENDSTOP_C false
...
#define min_software_endstop_a true
#define min_software_endstop_b true
#define min_software_endstop_c true
#define max_software_endstop_a true
#define max_software_endstop_b true
#define max_software_endstop_c true
#define DOOR_PIN -1
...
#define ENDSTOP_A_BACK_ON_HOME 1
#define ENDSTOP_B_BACK_ON_HOME 1
#define ENDSTOP_C_BACK_ON_HOME 1
...
#define A_MAX_LENGTH 100  //6axis in degree
#define B_MAX_LENGTH 100
#define C_MAX_LENGTH 100
#define X_MIN_POS 0
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define A_MIN_POS 0
...
#define PARK_POSITION_A_RAISE 10
#define PARK_POSITION_B_RAISE 10
#define PARK_POSITION_C_RAISE 10
...
#define DISTORTION_AMAX 190 //6axis
#define DISTORTION_BMAX 190
#define DISTORTION_CMAX 190
#define DISTORTION_AMIN 10
#define DISTORTION_BMIN 10
#define DISTORTION_CMIN 10
...
#define END_EFFECTOR_HORIZONTAL_OFFSET 43
#define CARRIAGE_HORIZONTAL_OFFSET 15.5
#define DELTA_MAX_RADIUS 150
#define ROD_RADIUS 135.4
...
#define DELTASEGMENTS_PER_PRINTLINE 10 //originally 24. reduce to free up memory
#define STEPPER_INACTIVE_TIME 360L
#define MAX_INACTIVE_TIME 0L
#define MAX_FEEDRATE_X 200
#define MAX_FEEDRATE_Y 200
#define MAX_FEEDRATE_Z 200
#define MAX_FEEDRATE_A 20    //6axis
#define MAX_FEEDRATE_B 20
#define MAX_FEEDRATE_C 20
#define HOMING_FEEDRATE_X 40
#define HOMING_FEEDRATE_Y 40
#define HOMING_FEEDRATE_Z 40
#define HOMING_FEEDRATE_A 2 //6axis
#define HOMING_FEEDRATE_B 2
#define HOMING_FEEDRATE_C 2
...
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_A 3000 //6AXIS
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_B 3000
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_C 3000
...
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_A 100  //6AXIS
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_B 100
...
#if (NUM_AXES >= 4)
    #define A_STEP_PIN ORIG_E0_STEP_PIN
    #define A_DIR_PIN ORIG_E0_DIR_PIN
    #define A_ENABLE_PIN ORIG_E0_ENABLE_PIN
#endif
#if (NUM_AXES >= 5)
    #define B_STEP_PIN ORIG_E1_STEP_PIN
    #define B_DIR_PIN ORIG_E1_DIR_PIN
    #define B_ENABLE_PIN ORIG_E1_ENABLE_PIN
#endif
#if (NUM_AXES >= 6)
    #define C_STEP_PIN ORIG_E2_STEP_PIN
    #define C_DIR_PIN ORIG_E2_DIR_PIN
    #define C_ENABLE_PIN ORIG_E2_ENABLE_PIN
#endif
...
#define SERVO2_PIN -1
#define SERVO3_PIN -1
#define SERVO0_NEUTRAL_POS  500
#define SERVO1_NEUTRAL_POS  500
...
#define FEATURE_CONTROLLER 2   //2 = 8bit, 11 = RepRapDiscount, 14 = LCD2004
...
#define UI_PRINTER_NAME "REPETIER 6AXIS"
#define UI_PRINTER_COMPANY "SPACE10 RESEARCH"
#define UI_PAGES_DURATION 15000
