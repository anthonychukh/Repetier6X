...
#define Y_AXIS 1
#define Z_AXIS 2
#define A_AXIS 3   //6axis
#define B_AXIS 4   //6axis
#define C_AXIS 5   //6axis
#define E_AXIS 6   //original 4
#define VIRTUAL_AXIS 7   //original 5
// How big an array to hold X_AXIS..<MAX_AXIS>
#define Z_AXIS_ARRAY 6 //6axis original 3. now 3+3 = 6. only for position, do not include E
#define E_AXIS_ARRAY 7 //6axis original 4. now 3+4 = 7. for cal step, therefore include E
#define VIRTUAL_AXIS_ARRAY 8 //originally 5. now 7+1. E array +1


#define A_TOWER 0
#define B_TOWER 1
#define C_TOWER 2
#define TOWER_ARRAY 3 //original 3
#define E_TOWER_ARRAY 4 //original 4
...
//combo's
#define XYZ_STEP 112
#define ABC_STEP 112  //6axis
#define XY_STEP 48
#define XYZE_STEP 240
#define E_STEP_DIRPOS 136
#define Y_STEP_DIRPOS 34  // = YSTEP + Y_DIRPOS
#define X_STEP_DIRPOS 17
#define Z_STEP_DIRPOS 68
#define B_STEP_DIRPOS 34  // = YSTEP + Y_DIRPOS
#define A_STEP_DIRPOS 17
#define C_STEP_DIRPOS 68
